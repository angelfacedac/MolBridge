...
def ParseArgs():
    ...
    parser.add_argument('--lr', default=0.00125, type=float, help='learning rate')
    parser.add_argument('--batch', default=256, type=int, help='batch size')
    parser.add_argument('--epoch', default=500, type=int, help='number of epochs')

    parser.add_argument('--n_class', default=86, type=int, help='number of class')
    ...
    parser.add_argument('--clip_n_atom', default=50, type=int, help='对齐原子数')
    ...
    parser.add_argument('--root_path', default="Data/Ryu's dataset", type=str, help='root_path')
